...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Option crc32c = new Option("cc", "crc32c", false, "");
        options.addOption(crc32c);
        Option md5 = new Option("m", "md5", false, "");
        options.addOption(md5);
        Option sha1 = new Option("s1", "sha1", false, "");
        options.addOption(sha1);
        Option sha256 = new Option("s2", "sha256", false, "");
        options.addOption(sha256);
        Option sha512 = new Option("s5", "sha512", false, "");
...
//        );
        ...
        String opt = cmd.getOptions()[0].getLongOpt();
        ...
        System.out.println(checksumCode.toString());
    }
}
